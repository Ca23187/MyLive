  ...
  <div :class="['header-bar', 'header-bar-' + theme]">
    ...
    <div class="user-panel">
            ...
            <div class="count-info">
              <div class="count-info-item">
                <div class="count-value">
                  {{ userCountInfo.followCount }}
                </div>
                <div class="count-title">Following</div>
              </div>
              <div class="count-info-item">
                <div class="count-value">
                  {{ userCountInfo.fanCount }}
                </div>
      ...
      <div
        ...
        @click="navJump(`/user/${loginStore.userInfo.userId}/saved`)"
      >
...
const loadingCountInfo = ref(false);

const getCountInfo = async () => {
  if (loadingCountInfo.value) {
    return;
  }

  loadingCountInfo.value = true;

  let result = await proxy.Request({
    url: proxy.Api.getUserCountInfo,
  });

  loadingCountInfo.value = false;
...
const logout = () => {
  proxy.Confirm({
    ...
    okfun: async () => {
      const needJumpAfterLogout = route.meta.requiresLogin === true;
