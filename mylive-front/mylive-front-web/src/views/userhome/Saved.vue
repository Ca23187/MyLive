        ...
        <div class="data-item">
          ...
          <div class="collection-info">
            <div class="collection-time">
              Saved at: {{ proxy.Utils.formatDate(data.actionTime) }}
            </div>
            <el-dropdown>
...
const cancelCollection = (data) => {
  proxy.Confirm({
    message: "Remove from saved videos?",
    okfun: async () => {
      let result = await proxy.Request({
