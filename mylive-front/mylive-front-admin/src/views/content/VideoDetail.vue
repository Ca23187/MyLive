      ...
      <div class="video-info">
        <el-tabs v-model="activeName">
          <el-tab-pane label="Videos" name="video">
            <div class="video-tips">Red titles indicate updated videos</div>
          ...
          <el-tab-pane label="Basic Information" name="base">
            <div class="video-base-info">
              <div class="base-info-item">
                <div class="item-title">Title:</div>
                <div class="item-value">{{ videoInfo.videoTitle }}</div>
              </div>
              <div class="base-info-item">
                <div class="item-title">Uploader:</div>
                <div class="item-value">{{ videoInfo.nickname }}</div>
              </div>
              <div class="base-info-item">
                <div class="item-title">Type:</div>
                <div class="item-value">
                  {{ videoInfo.postType == 0 ? "Original" : "Reposted" }}
                </div>
              </div>
...
const loadPList = async () => {
  let result = await proxy.Request({
    url: proxy.Api.loadVideoPartList,
    params: {
