...
const Api = {
    ...
    reorderCategory: "/category/reorder",
    //视频
    loadVideoPostList: "/videoInfo/loadVideoPostList",
    loadVideoPartList: "/videoInfo/loadVideoPartList",
    //推荐视频
    ...
    //弹幕
    loadDanmaku: "/interact/loadDanmaku",
    delDanmaku: "/interact/delDanmaku",
    //用户管理
    loadUser: "/user/loadUser",
    changeStatus: "/user/changeStatus",
    //视频资源
    getVideoResource: "/api/file/videoResource",
    reviewVideo: "/videoInfo/reviewVideo",
    deleteVideo: "/videoInfo/deleteVideo",
    getSetting: "/setting/getSetting",
    saveSetting: "/setting/saveSetting",
    //首页统计数据
    getRealTimeStatisticInfo: "/index/getRealTimeStatisticInfo",
    getWeekStatisticInfo: "/index/getWeekStatisticInfo"
}
