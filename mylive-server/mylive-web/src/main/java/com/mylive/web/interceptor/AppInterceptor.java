package com.mylive.web.interceptor;
...
public class AppInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        Cookie cookie = WebUtils.getCookie(request, Constants.TOKEN_WEB);
        if (cookie == null || redisComponent.getTokenInfo(cookie.getValue()) == null) {
